...
export default function OpenView() {
  const initiatives = [
    ...
    {
      icon: BookOpen,
      title: "IT education and mentorship programs",
      description:
        "Empowering the next generation of technologists through knowledge sharing and guidance.",
    },
    {
      icon: Globe,
      title: "Active participation in tech communities",
      description:
        "Engaging with and supporting technology communities around the world.",
    },
    {
      icon: Lightbulb,
      title: "Promoting equitable digital access",
      description:
        "Working to ensure technology is accessible to all, regardless of background or location.",
    },
  ];
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Collaborative projects and programs that drive technological
